                                                    ...
                                                    >
                                                        ...
                                                        <div className="col-6 d-flex align-items-center mt-1 mb-1">
                                                                <div className="card d-flex flex-row align-items-center border-0">
                                                                    <LuIndianRupee color="#4F4B7E" className="me-2" style={{fontSize:"18px"}}/>
                                                                    <div className="card-body p-1">
                                                                        <span className="text-muted"style={{fontSize:"10px"}}>YOUR RENT</span>
                                                                        <p>6000</p>
                                                                    </div>
                                                                </div>         
                                                            </div>
                                                            <div className="col-6 d-flex align-items-center mt-1 mb-1">
                                                                <div className="card d-flex flex-row align-items-center border-0">
                                                                    <LuIndianRupee color="#4F4B7E" className="me-2" style={{fontSize:"18px"}}/>
                                                                    <div className="card-body p-1">
                                                                        <span className="text-muted"style={{fontSize:"10px"}}>OFFER RENT</span>
                                                                        <p>5000</p>
                                                                    </div>
                                                                </div>         
                                                            </div>
