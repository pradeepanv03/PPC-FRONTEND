                                                    ...
                                                    >
                                                        <div className="d-flex align-items-start mb-3">
                                                            ...
                                                            <div className="ms-3 flex-grow-1">
                                                                <div className="rounded-1" style={{border:'2px solid #4F4B7E'}} ><p className="text-center p-1 m-0" style={{color:"#4F4B7E"}}>PHOTO REQUEST</p> </div>
                                                        ...
                                                        <div className="row">
                                                        <div className="col-4 d-flex align-items-center justify-content-center mt-1 mb-1 rounded-1" style={{border:'2px solid #4F4B7E'}} >
                                                                <div className="card d-flex flex-col align-items-center border-0 " >
                                                                    <IoCamera  color="#4F4B7E" className="me-2"  style={{fontSize:"18px"}} />
                                                                    <div className="card-body p-1">
                                                                        <span className="text-muted" style={{fontSize:"10px"}}>Add Property image</span>
                                                                    </div>
                                                                </div>         
                                                            </div>
                                                        <div className="col-8 d-flex align-items-center mt-1 mb-1 ">
                                                            <div className="col">
                                                                <div className="card d-flex flex-row align-items-center border-0" >
                                                                    ...
                                                                    <div className="card-body p-1">
                                                                        ...
                                                                        <p className="m-0">{card.mobileNumber.slice(0, -5)}*****</p>
                                                                    </div>
                                                                </div>    
                                                                <div className="card d-flex flex-row align-items-center border-0">
                                                                    <MdCalendarMonth color="#4F4B7E" className="me-2" style={{fontSize:"18px"}}/>
                                                                    <div className="card-body p-1">
                                                                        <span className="text-muted"style={{fontSize:"10px"}}>PHOTO REQUESTED  DATE</span>
                                                                        <p className="m-0">02/01/24</p>
                                                                    </div>
                                                                </div> 
                                                                </div>
...
export default PhotoRequestSent;
